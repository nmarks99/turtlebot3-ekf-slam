...
public:
  ...
  : Node("landmarks")
  {
    ...
    cluster_pub = create_publisher<visualization_msgs::msg::MarkerArray>("/clusters", 10);

    detected_landmarks_pub = create_publisher<nuslam::msg::PointArray>("/detected_landmarks", 10);
  }
